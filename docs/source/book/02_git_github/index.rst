...
потім використовувати його для робочих завдань. Завдання та приклади книги
знаходяться в окремому `репозиторії на GitHub <https://github.com/natenka/pyneng-examples-exercises/>`__.
